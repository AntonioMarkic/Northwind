<?php
  ...
  ini_set('soap.wsdl_cache_ttl',0);
    ...
    $sClient = new SoapClient('http://localhost/soap/wsdl/product.wsdl',
    ...
    <div class="row">
      <div class="col-12 menu">
        <ul>
             ...
             <a class="btn btn-primary" href="products.html" role="button">Products</a>
                  ...
                  <?php
		                for($j=0;$j<sizeof($response);$j++) {
                          echo "<hr><div class='customers'>
                                <p><i>ProductName: </i> <b><i>".$response[$j][0]."</i></b></p>
                                <p><i>CompanyName: </i> <b><i>".$response[$j][1]."</i></b></p>
                                <p><i>CategoryName: </i> <b><i>".$response[$j][2]."</i></b></p>
                                <p><i>QuantityPerUnit: </i> <b><i>".$response[$j][3]."</i></b></p>
                                <p><i>UnitPrice: </i> <b><i>".$response[$j][4]."</i></b></p>
								<p><i>UnitInStock: </i> <b><i>".$response[$j][5]."</i></b></p>
                                <p><i>UnitsOnOrder: </i> <b><i>".$response[$j][6]."</i></b></p>
                                <p><i>RecorederLevel: </i> <b><i>".$response[$j][7]."</i></b></p>
                                <p><i>Discounted: </i> <b><i>".$response[$j][8]."</i></b></p>
                            </div>";
					            }
				            ?>
              </div>
