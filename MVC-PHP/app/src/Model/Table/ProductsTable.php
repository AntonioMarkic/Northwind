...
class ProductsTable extends Table
{
    ...
    public function validationDefault(Validator $validator): Validator
    {
        ...
        $validator
            ->scalar('QuantityPerUnit')
            ->maxLength('QuantityPerUnit', 20)
            ->allowEmptyString('QuantityPerUnit');

        $validator
            ->decimal('UnitPrice')
            ->allowEmptyString('UnitPrice');

        $validator
            ->allowEmptyString('UnitsInStock');

        $validator
            ->allowEmptyString('UnitsOnOrder');
